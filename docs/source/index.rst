...
Not supporting Python 2.x was a difficult decission to make, as we are aware that
Python 2.x is still popular among VirusTotal users, but in the long run we think
it's the right one.
