...
class RetroHuntJobToNetworkInfrastructureHandler:
    ...
    async def get_network_infrastructure(self, file_obj):
        ...
        await self.networking_queue.put(
            {"contacted_addresses": contacted_urls, "type": "urls", "file": file_hash}
        )
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Get files from the VirusTotal feed.")
