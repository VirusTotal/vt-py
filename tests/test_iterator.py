...
def fixture_iterator_response(httpserver):
    httpserver.expect_ordered_request(
        ...
        {
            "data": [
                {"id": "dummy_id_1", "type": "dummy_type", "attributes": {"order": 0}},
                {"id": "dummy_id_2", "type": "dummy_type", "attributes": {"order": 0}},
                {"id": "dummy_id_3", "type": "dummy_type", "attributes": {"order": 0}},
            ],
    ...
    httpserver.expect_ordered_request(
        ...
        {
            "data": [
                {"id": "dummy_id_4", "type": "dummy_type", "attributes": {"order": 0}},
                {
                    "id": "dummy_id_5",
                    "type": "dummy_type",
...
async def test_anext(httpserver, iterator_response):  # pylint: disable=unused-argument
    ...
    async with new_client(httpserver) as client:
        ...
        assert (
            await it.__anext__()
        ).id == "dummy_id_1"  # pylint: disable=unnecessary-dunder-call
