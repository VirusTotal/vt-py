...
from typing import Any, BinaryIO, Coroutine, Optional, Tuple, Union
import aiohttp
import asyncio
import base64
import json
...
def _make_sync(future: Coroutine):
...
class StreamReader:
  ...
  async def readchunk_async(self) -> Tuple[bytes, bool]:
    return await self._aiohttp_stream_reader.readchunk()

  def readchunk(self) -> Tuple[bytes, bool]:
...
class Client:
  ...
  def __init__(self, apikey: str, agent:str="unknown", host: Optional[str] = None, trust_env: bool = False):
  ...
  def delete(self, path: str, *path_args) -> ClientResponse:
  ...
  async def delete_async(self, path: str, *path_args) -> ClientResponse:
    """Like :func:`delete` but returns a coroutine."""
    return ClientResponse(
        await self._get_session().delete(self._full_url(path, *path_args)))

  def download_file(self, hash: str, file: BinaryIO):
  ...
  async def download_file_async(self, hash: str, file: BinaryIO):
  ...
  def feed(self, feed_type: FeedType, cursor: Optional[str] = None) -> Feed:
  ...
  def get(self, path: str, *path_args, params: Optional[dict] = None) -> ClientResponse:
  ...
  async def get_async(self, path: str, *path_args, params: Optional[dict] = None) -> ClientResponse:
  ...
  def get_data(self, path: str, *path_args, params: Optional[dict] = None) -> Any:
  ...
  async def get_data_async(self, path: str, *path_args, params: Optional[dict] = None) -> Any:
  ...
  async def get_error_async(self, response: ClientResponse) -> Optional[APIError]:
  ...
  def get_json(self, path: str, *path_args, params: Optional[dict] = None) -> Any:
  ...
  async def get_json_async(self, path: str, *path_args, params: Optional[dict] = None) -> Any:
  ...
  def get_object(self, path: str, *path_args, params: Optional[dict] = None) -> Object:
  ...
  async def get_object_async(self, path: str, *path_args, params: Optional[dict] = None) -> Object:
    """Like :func:`get_object` but returns a coroutine."""
    response = await self.get_async(path, *path_args, params=params)
    return await self._response_to_object(response)

  def patch(self, path: str, *path_args, data: Optional[Union[str, bytes]] = None) -> ClientResponse:
  ...
  async def patch_async(self, path: str, *path_args, data: Optional[Union[str, bytes]] = None) -> ClientResponse:
  ...
  def patch_object(self, path: str, *path_args, obj: Object) -> Object:
  ...
  async def patch_object_async(self, path: str, *path_args, obj: Object) -> Object:
  ...
  def post(self, path: str, *path_args, data: Optional[Union[str, bytes]] = None) -> ClientResponse:
    """Sends a POST request to a given API endpoint.j
  ...
  async def post_async(self, path: str, *path_args, data: Optional[Union[str, bytes]] = None) -> ClientResponse:
  ...
  def post_object(self, path: str, *path_args, obj: Object) -> Object:
  ...
  async def post_object_async(self, path: str, *path_args, obj: Object) -> Object:
  ...
  def iterator(self, path: str, *path_args, params: Optional[dict] = None, cursor: Optional[str] = None,
               limit: Optional[int] = None, batch_size: int = 0) -> Iterator:
  ...
  def scan_file(self, file: BinaryIO, wait_for_completion: bool = False) -> Object:
    """Scans a file.
  ...
  async def scan_file_async(self, file: BinaryIO, wait_for_completion: bool = False) -> Object:
  ...
  async def scan_url_async(self, url: str, wait_for_completion: bool = False) -> Object:
